...
h5_file = '/home/prota/Workspace/deep-splicing/data/crops_p128x128.h5'
logdir = './log'
sampledir = './samples'
...
# data normalization not needed

print('shape x: {}'.format(x.shape))
print('shape y: {}'.format(y.shape))
print('data loaded in {0:3.3} sec'.format(time.time() - t0))

gan = DCGAN(x, y, log_dir=this_logdir, sample_dir=this_sampledir, channel_x=3, channel_y=1)
